...
class RefreshManager:
    ...
    FIREFLY_ORIGIN = "https://firefly.adobe.com"
    DEFAULT_SCOPE = ",".join(
        (
            "AdobeID",
            "firefly_api",
    ...
    def _validate_bundle(bundle: Dict) -> Dict:
        ...
        normalized_headers = {
            ...
            "Origin": RefreshManager.FIREFLY_ORIGIN,
            "Referer": f"{RefreshManager.FIREFLY_ORIGIN}/",
            "User-Agent": str(headers.get("User-Agent") or "Mozilla/5.0"),
        }

        normalized_form = {
            "client_id": RefreshManager.CLIENT_ID,
        ...
        validated = self._validate_bundle(
            {
                "endpoint": {
                    ...
                    "headers": {
                        ...
                        "Cookie": cookie,
                        "Origin": self.FIREFLY_ORIGIN,
                        "Referer": f"{self.FIREFLY_ORIGIN}/",
